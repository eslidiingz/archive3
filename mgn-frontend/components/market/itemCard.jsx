...
const MarketModal = ({ data = {}, handleFetchInventoryItem, ...props }) => {
      ...
      <div className="box-card-asste">
        ...
        <div className="row card-set-text">
          <div className="col-12 mb-2">
            ...
            <div className="d-flex justify-content-between set-hover mt-1">
            ...
            <div className="row px-1">
              <div className={props.classname}>
                {/* <UseModal
                                    ...
                                    handleClaimLand={props.handleClaimLand}
                                    disabled={isNotReady}
                                /> */}
              </div>
              <div className={props.classname}>
                {/* <SellModal data={data} handleFetchInventoryItem={handleFetchInventoryItem} /> */}
              </div>
              <div className={props.className}>
                <Link href={`/market/detail/${data.orderId}`}>
